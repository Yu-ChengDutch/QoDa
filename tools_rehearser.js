...
let databases = {
    "Pathology - Ophthalmology": {"Database": './data_pathology_ophtha.json', "Iterators": ["Division"], "Questions": ["Definition", "Signs", "Subconditions", "Epidemiology", "Alternative name", "Complications"]},
